    ...
    if ($bookedtimes != null) {
        foreach ($bookedtimes as $bookedtime) {
            if ($bookedtime["1"] == true) {
                $tmp = '<a href="detail.php?date=' . $date . '&time=' . $bookedtime[0] . '" class="badge badge-success">' . $bookedtime[0] . " " . $bookedtime[2] . "/" . $bookedtime[3] . '</a><br>';
                $result = $result . $tmp;
            } else {
                $tmp = '<a href="detail.php?date=' . $date . '&time=' . $bookedtime[0] . '" class="badge badge-success">' . $bookedtime[0] . " " . $bookedtime[2] . "/" . $bookedtime[3] . '</a><br>';
                $result = $result . $tmp;
...
<div class="card">
    <div class="card-body">
        As an administrator, you can click on a specified time to show which users have booked that time or
        <?php if ($auth->authorize(["admin"])) : ?>
            <a class="btn btn-primary" href="newdate.php">Post a new date</a>
        <?php endif; ?>
    </div>
</div>
